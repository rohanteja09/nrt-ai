...
export default function Home() {
  return (
    <div className="flex min-h-0 flex-1 pointer-events-none">
      <Sidebar />
      <div className="flex min-h-0 flex-1 flex-col pointer-events-none">
        <header className="pointer-events-auto relative border-b border-white/40 bg-white/60 px-4 py-3 backdrop-blur-md dark:border-white/5 dark:bg-zinc-950/50">
